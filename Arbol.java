...
public class Arbol{
	...
	public static void main(String[] args) {
		...
		do{
			...
			System.out.println("3: Obtener anchura");
			System.out.println("4: Obtener inorden");
			System.out.println("5: Obtener preorden");
			System.out.println("6: Obtener postorden");
			System.out.println("7: Obtener hojas");
			System.out.println("8: Obtener altura (profundidad)");
			...
			switch(in.nextLine()){
				...
				case "2":
					...
					in.nextLine();
				break;
				case "3": System.out.println("Su anchura es "+raiz.anchura());
				break;
				case "4": System.out.println("inorder es  "+raiz.inorder());
				break;
				case "5": System.out.println("preorder es  "+raiz.preorder());
				break;
				case "6": System.out.println("postorder es  "+raiz.postorder());
				break;
				case "7": System.out.println("Sus hojas son "+raiz.hojas());
				break;
				case "8": System.out.println("Su altura es "+raiz.altura());
				break;
				case "0": 
